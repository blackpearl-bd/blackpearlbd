  ...
  return (
    ...
    >
      <div
        ...
        className={cn(
          "absolute inset-0 z-0 flex overflow-hidden rounded-lg",
          classNames?.rail,
        )}
        {...(!openSide ? { inert: "" } : {})}
      >
        <div className="flex h-full overflow-hidden rounded-l-lg">
        ...
        <div className="ml-auto flex h-full overflow-hidden rounded-r-lg">
      ...
      <motion.div
        ...
        className={cn(
          ...
          "relative z-10 min-h-[72px] cursor-grab touch-pan-y rounded-lg border border-border bg-card px-4 py-3 shadow-sm active:cursor-grabbing",
