...
export interface WheelPickerProps {
  ...
  itemHeight?: number;
  disabled?: boolean;
  /** Play a short tick each time the selected value changes. Default true. */
  sound?: boolean;
  className?: string;
  'aria-label'?: string;
}
...
export function WheelPicker({
        ...
        {!disabled && (
          <>
            <button
              ...
              aria-hidden
              onClick={() => step(-1)}
              className="absolute left-0 right-0 top-0 z-20 flex h-6 items-center justify-center text-muted-foreground/60 transition-colors hover:text-foreground hover:bg-accent/30"
            >
            ...
            <button
              ...
              aria-hidden
              onClick={() => step(1)}
              className="absolute left-0 right-0 bottom-0 z-20 flex h-6 items-center justify-center text-muted-foreground/60 transition-colors hover:text-foreground hover:bg-accent/30"
            >
  ...
  return (
    <div
      ...
      className={cn(
        'relative touch-none overflow-hidden rounded-lg border border-border bg-card outline-none focus-visible:ring-2 focus-visible:ring-foreground/20',
